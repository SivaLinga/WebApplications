...
public class TicketManagementDaoImpl implements TicketManagementDao {
	...
	public List<Login> retrieveEmail(User user) {
		...
		Object[] args = new Object[] { user.getLogin().getEmail() };
		List<Map<String, Object>> loginDataFromDb = jdbcTemplate.queryForList(query, args);
		List<Login> loginList = new ArrayList<Login>();
		for (Map<String, Object> map : loginDataFromDb) {
			Login loginObj = new Login();
			loginObj.setEmail((String) map.get("email"));
