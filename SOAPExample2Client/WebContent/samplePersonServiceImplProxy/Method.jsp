...
<LI><A HREF="Input.jsp?method=13" TARGET="inputs"> addPerson(com.journaldev.jaxws.beans.Person)</A></LI>
<LI><A HREF="Input.jsp?method=24" TARGET="inputs"> getPerson(int)</A></LI>
</UL>
</BODY>
</HTML>